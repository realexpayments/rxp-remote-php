...
class AmountNormalizer implements NormalizerInterface, DenormalizerInterface {
	...
	public function normalize( $object, $format = null, array $context = array() ) {
		...
		return array(
			'@currency' => $object->getCurrency() == null ? "" : $object->getCurrency(),
			'#'         => $object->getAmount()
		);
	}
	...
	public function supportsNormalization( $data, $format = null ) {
		if ( $format == "xml" && $data instanceof Amount ) {
			return true;
		}
		return false;
	}
